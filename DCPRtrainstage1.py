...
def create_generator(generator_inputs, discrimCon1, discrimCon2, generator_outputs_channels):
    ...
    layer_specs = [
        ...
        a.ngf * 8,  # encoder_3: [batch, 64, 64, ngf * 2] => [batch, 32, 32, ngf * 4]
...
def create_model(inputs, condition1, condition2, targets):
    ...
    def perceptual_Loss(perceTarget, perceOutput):
        ...
        weights = [1.0, 2.0, 2.0]
        perLoss = 0.0
        for i in range(1,len(perceTarget)-1):
    ...
    with tf.name_scope("discriminator_loss"):
        ...
        discrim_loss = global_discrim_loss +discrim_loss_per*a.dis_per_w
...
def main():
    ...
    # a.checkpoint = "D://Users//user//Desktop//weiyundontdelete//GANdata//trainingdepth//DAISdepth//alldata//model//dcprallcheck//"
    # a.mode = "export"
    # a.output_dir ="D://Users//user//Desktop//weiyundontdelete//GANdata//trainingdepth//DAISdepth//alldata//exportmodel//dcprallcheck//"
    # a.which_direction = "BtoA"
    # a.mode = "export"
