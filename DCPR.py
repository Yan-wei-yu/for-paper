...
def create_model(inputs, condition1, condition2, targets):
    ...
    with tf.name_scope("discriminator_loss"):
        ...
        # 判別器損失
        global_discrim_loss = tf.reduce_mean(-(tf.log(predict_real[-1] + EPS) + tf.log(1 - predict_fake[-1] + EPS)))        # 判別局部特徵是否真實。
...
def main():
    ...
    # a.mode = "train"
    # a.output_dir = "D://Users//user//Desktop//weiyundontdelete//GANdata//trainingdepth//DAISdepth//alldata//model//DCPRr=0papernohistorgramcgan//"
    # a.max_epochs=250
    # a.which_direction = "BtoA"

    a.checkpoint = "D://Users//user//Desktop//weiyundontdelete//GANdata//trainingdepth//DAISdepth//alldata//model//DCPRr=0papernohistorgramcgan//"
    a.mode = "export"
    a.output_dir ="D://Users//user//Desktop//weiyundontdelete//GANdata//trainingdepth//DAISdepth//alldata//exportmodel//DCPRr=0papernohistorgramcgan//"
    a.which_direction = "BtoA"
